...
results_mus = replicate(N, run_ltm_and_ltmCluster(r$ch, r$no_ch, 6:11, length(6:11), 14, 0.7, 3))

result_mus = fct_result(results_mus, N)
print(result_mus$mean)
print(result_mus$sd)

# > print(result_mus$mean)
#                           AUC     PCM     ER
# res_ltm_mean         0.5575743 0.75425 28.573
# res_ltm_cluster_mean 0.5738352 0.74375 18.609
# > print(result_mus$sd)
#                           AUC          PCM         ER
# res_ltm_sd         0.000408520 0.0017677670 0.04666905
# res_ltm_cluster_sd 0.002798326 0.0003535534 0.91923882
...
results_bos = replicate(N, run_ltm_and_ltmCluster(r2$ch, r2$no_ch, 1:6, length(1:6), 11, 0.7, 3))
# IndLU_t1: 7; IndLU_t2=8; CodeNU= 1; CodeU= 2

result_bos = fct_result(results_bos, N)
print(result_bos$mean)
print(result_bos$sd)
...
rLux = read_data("S-B project_2015.mat", 6:11, 14, 4, 5, 0, 1) 

loadMat = function(fileName)
{
  rawData = readMat("data/S-Bproject_2015.mat")
  data = rawData[[1]]
  return(data)
}
